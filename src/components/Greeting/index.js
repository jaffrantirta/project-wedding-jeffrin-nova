    ...
    return (
        <section className='h-fit' ref={sectionRef}>
            ...
            <div className='bg-primary justify-center flex flex-col p-10'>
                <img alt='o-swastyastu' src={ImgSwastyastu} className={`w-96 h-auto md:h-fit self-center transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-24'}`} />
